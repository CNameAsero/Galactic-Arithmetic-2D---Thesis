...
var number_scene = load("res://Scenes/Mechanics/testing_numbers.tscn")
...
func save_collectible_parentheses(collectible):
	...
	collected_parentheses_dict[collectible.name] = collectible_parentheses
...
func save_collectible_variable(collectible):
	...
	collected_variables_dict[collectible.name] = collectible_variable
